const { queryOptions } = require('../util/queryOptions');
const createQuery = require('../util/createQuery');
 ...
 * @param {(String[] | String[][])} [values] The values - in order - to insert into the table. If set to `null`, DEFAULT VALUES will be inserted. If several rows are to be inserted, values has to be a two-dimensional array.
 * @returns {Statement}
 */
